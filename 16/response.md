Below is an **updated `script.js`** that keeps the simple click-to-toggle workflow and turns the orange lasso **only when you actually drag into a different cell**.
